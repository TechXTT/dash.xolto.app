    ...
    <div className="onboarding-backdrop">
      <form className="onboarding-card location-setup-card" onSubmit={handleSubmit}>
        ...
        <p className="onboarding-body">
          Your default location decides which marketplaces become eligible for missions and keeps crawling focused on the places you can actually buy from.
        </p>
        ...
        <div className="location-grid">
          <div className="input-stack">
            ...
            <input id="location-name" className="input" value={name} onChange={(e) => setName(e.target.value)} placeholder="Your name" />
          </div>
          ...
          <div className="input-stack">
            ...
            <select id="location-country" className="input" value={countryCode} onChange={(e) => setCountryCode(e.target.value)}>
          ...
          <div className="input-stack">
            ...
            <input id="location-city" className="input" value={city} onChange={(e) => setCity(e.target.value)} placeholder="Amsterdam" />
          </div>
          ...
          <div className="input-stack">
            ...
            <input id="location-region" className="input" value={region} onChange={(e) => setRegion(e.target.value)} placeholder="North Holland" />
          </div>
          ...
          <div className="input-stack">
            ...
            <input id="location-postal" className="input" value={postalCode} onChange={(e) => setPostalCode(e.target.value)} placeholder="1012 AB" />
          </div>
